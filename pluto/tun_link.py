...
Usage:
    sudo .venv/bin/python -m pluto.tun_link                          # node autodetected, full-duplex
    sudo .venv/bin/python -m pluto.tun_link --mode tx                # TX-only (autodetect)
    sudo .venv/bin/python -m pluto.tun_link --node B --mode rx       # force node B, RX-only
"""
