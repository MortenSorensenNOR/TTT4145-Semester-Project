...
| SPAN | 8 | |
| RRC alpha | 0.25 | |
| RRC taps | 97 | 2 × SPS × SPAN + 1 |
| Symbol period | 1.5 μs | |
| Sample rate | TBD Mhz | |
| Occupied bandwidth | TBD kHz | |
| Throughput | 1 Mbps | |
| Channel coding | Temporarily removed | 802.11 base matrices (proven, existing implementation) |
| Coding gain | N/A  |  |
| Link margin | 15.5 dB | |
